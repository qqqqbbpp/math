    ...
    return (
        <>
            ...
            <main tabIndex={1}>
                <div className="main">
                    <h1 id="1">Сложение</h1>
                        <p>Сложение&nbsp;&mdash; это арифмитическая операция, результатаом которой явялется сумма двух слагаемых.</p>
                        ...
                        <h2 id="6">Свойства операций</h2>
                            <p>Свойства операций&nbsp;&mdash; это правила, описывающие, как выполняются различные математические действия.</p>
