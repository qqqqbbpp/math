            ...
            <main tabIndex={1}>
                <div className="main">
                    ...
                    <h2 id="6">Показатели вариации</h2>
                        ...
                        <h3 id="6c">Среднее квадратическое отклонение</h3>
                            <p><Latex>{`$\\sigma_B = \\sqrt{D_B}$`}</Latex></p>
                        <h3 id="6d">Коэффициент вариации</h3>
                    ...
                    <h2 id="7">Статистическое оценивание</h2>
                        ...
                        <p>Точность интервальной оценки <Latex>{`$\\Delta$`}</Latex> находят, используя следующее равенство:</p>
                    ...
                    <h2 id="8">Проверка статистических гипотез</h2>
                        ...
                        <h3 id="8c">Проверка гипотезы о равенстве генеральных дисперсий</h3>
                            ...
                            <p>Наблюдаемое значение критерия рассчитывается по формуле:</p>
                        ...
                        <h3 id="8e">Проверка гипотезы о равенстве вероятностей</h3>
                            ...
                            <p><Latex>{`$H_1''': p < P_0$`}</Latex></p>
                            <p>Задают уровень значимости <Latex>{`$\\alpha = P_{H_0} (H_1).$`}</Latex> В качестве инструмента используется случайная величина <Latex>{`$U \\sim N(\\alpha = 0, ~\\sigma = 1)$`}</Latex></p>
                            <p>Наблюдаемое значение критерия рассчитывается по формуле:</p>
