        ...
        <>
            <main>
                <div className="main">
                    ...
                    <div className="button"><button type="button" aria-label="Поделить 1 на 10 деленное на n" onClick={handlePositiveDivideClick} disabled={divider >= 9}><Latex>{`$:10/${divider + 1}$`}</Latex></button></div>
                    ...
                    <div className="button"><button type="button" aria-label="Поделить 1 на минус 10 деленное на n" onClick={handleNegativeDivideClick} disabled={negativeDivider >= 9}><Latex>{`$:-10/${negativeDivider + 1}$`}</Latex></button></div>
