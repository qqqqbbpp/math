        ...
        <>
            <main>
                <div className="main">
                    ...
                    <div className="button"><button type="button" aria-label="Прибавить 1" onClick={handlePositiveClick}><Latex>{`$+1$`}</Latex></button></div>
                    ...
                    <div className="button"><button type="button" aria-label="Вычесть 1" onClick={handleNegativeClick}><Latex>{`$-1$`}</Latex></button></div>
                    <h5 id="1a1a3">Ноль</h5>
                    ...
                    <div className="button"><button type="button" aria-label="Поделить 1 на 10 деленное на n" onClick={handlePositiveDivideClick} disabled={divider >= 9}><Latex>{`$:\\frac{10}{${divider + 1}}$`}</Latex></button></div>
                    ...
                    <div className="button"><button type="button" aria-label="Поделить 1 на минус 10 деленное на n" onClick={handleNegativeDivideClick} disabled={negativeDivider >= 9}><Latex>{`$ : -\\frac{10}{${negativeDivider + 1}}$`}</Latex></button></div>
